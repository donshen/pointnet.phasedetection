...
#         print(trans.cpu().detach().numpy().shape)
#         for i in range(trans.cpu().detach().numpy().shape[0]):
#             token = random.randint(100000000, 200000000)
#             np.savetxt('./STN_pts/lam_STN_matrix_{}.pts'.format(token), trans.cpu().detach().numpy()[i,:,:])
